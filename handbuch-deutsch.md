...
Damit Sie jahrelang Freude am OPUS® haben, muss der Zeltbereich gepflegt werden und darf nicht nass/feucht eingepackt werden.

Natürlich ist es manchmal unvermeidlich, dass Sie Ihren OPUS® einpacken müssen, wenn die Zeltplane nass ist. Es ist sehr wichtig, dass der OPUS® so schnell wie möglich zum Trocknen geöffnet wird, was innerhalb von 24 Stunden geschehen sollte.

Aufgrund der Beschaffenheit des Zeltes ist es möglich, dass bei den ersten Einsätzen bei nassem Wetter eine geringe Menge Wasser eindringt; dies ist normal, da das Zelt eine "Verwitterung" oder "Konditionierung" durchläuft. Sollte dies weiterhin der Fall sein, benachrichtigen Sie uns bitte so schnell wie möglich. Bitte beachten Sie den Abschnitt "Wassereintritt" unter "Fehlerbehebung".

- Mit Ausnahme des mitgelieferten Gaskochers sollten Sie im OPUS® keine offenen Flammen oder Gasgeräte verwenden und das Zelt nicht in Brand setzen.
- Sorgen Sie stets für eine ausreichende Belüftung des Wohnwagens, insbesondere beim Schlafen.
- Lassen Sie Kondenswasser abtrocknen, bevor Sie den Camper verpacken/lagern.
- Überprüfen Sie regelmäßig die Nähte des Zeltes und tragen Sie bei Bedarf eine Nahtversiegelung wie Kampa Seam Sealer oder eine geeignete Alternative auf. Befolgen Sie die Anweisungen des Produkts und lassen Sie es vor dem Verpacken vollständig trocknen.
- Überprüfen Sie regelmäßig die Klettverschlüsse und Nähte sowie die Clips an den Innenzelten.
- Öffnen oder schließen Sie die Reißverschlüsse des Zelts niemals mit Gewalt; überprüfen Sie sie auf Probleme und beheben Sie sie gegebenenfalls.
- Vergewissern Sie sich, dass die Reißverschlüsse ordnungsgemäß verwendet und gepflegt werden; bei Bedarf können Sie ein Gleitmittel für die Reißverschlüsse verwenden, um eine reibungslose Funktion zu gewährleisten.
- Überprüfen Sie das Zelt regelmäßig auf Löcher, Risse und Beschädigungen und halten Sie ein geeignetes Zeltreparaturset für Notfälle bereit.
- Vergewissern Sie sich, dass die Markisenwülste mittig und innerhalb der Markisenschienen liegen, bevor Sie das Camper-Zelt vollständig abspannen.
- Schließen Sie vor dem Abspannen immer den Reißverschluss der Zelttür, um sicherzustellen, dass das Zelt mit allen Abschnitten in der richtigen Position abgespannt ist, und um Risse zu vermeiden.
- Achten Sie beim Auf- und Abbau des Camper darauf, dass sich das Zelt und die Markisenwülste nicht verfangen oder verhaken; sollte dies der Fall sein, gehen Sie die Schritte zurück und versuchen Sie es erneut, um sicherzustellen, dass das Problem behoben ist.
- Sollte ein Riss auftreten, prüfen Sie den Schaden, bevor Sie Maßnahmen ergreifen. Wenn Sie unsicher sind, kontaktieren Sie uns unter 01473 601200. Kleine Risse können mit dem entsprechenden Reparaturset und -verfahren repariert werden und erfordern keinen Fachmann oder eine Rücksendung an uns; sollte der Schaden erheblich sein oder Ihre Kapazitäten übersteigen, wenden Sie sich bitte an uns.
- Reinigen Sie das Zelt mit warmem Wasser und einem weichen Schwamm (ohne Scheuermittel); je nach Lage/Schwere des Flecks kann es erforderlich sein, den Camper komplett aufzustellen (das Zelt vollständig abzuspannen); lassen Sie das Zelt vor dem Einpacken vollständig trocknen.
- Verwenden Sie kein Spülmittel, Waschmittel oder etwas Stärkeres, da dies das Zelt beeinträchtigen oder beschädigen könnte.
- Das Zelt ist NICHT maschinenwaschbar.
- Weitere Informationen zum Reinigen und Imprägnieren finden Sie weiter unten unter "Spezialprodukte für Ihr OPUS®-Zelttuch" - dieselben Produkte, die auch für Ihr Sonnendach und Ihr komplettes Vorzelt (Sonderzubehör) empfohlen werden.
- Ziehen Sie das Gestänge des Wohnmobils immer gleichmäßig in kleinen Schritten ein und aus, um Schäden am Zelt zu vermeiden.
- Spannen Sie das Zelttuch NICHT zu stark.
- Die Spannung des Zelttuches kann mit Hilfe der Zelt-/Vormarkisenklappe überprüft werden; wenn sie gespannt ist, ist sie straff, aber nicht fest.
...
3.  Fenwicks Reiniger für Vorzelte und Zelte
4.  Zip-Gleitmittel
...
- Überprüfen Sie regelmäßig die Dichtungen (in der Mitte und am Umfang) des Wohnmobils, um sicherzustellen, dass sie nicht beschädigt wurden. An den Enden der mittleren Dichtungen können kleinere Risse auftreten. Diese werden sich durch den Gebrauch nicht verschlimmern und beeinträchtigen nicht die Fähigkeit des OPUS® , das Eindringen von Wasser zu verhindern. Vergewissern Sie sich, dass der Camper ordnungsgemäß verpackt ist, um den Camper abzudichten und das Eindringen von Wasser zu verhindern.
- Halten Sie die Karosserie und das Dach des Wohnwagens sauber. Am besten reinigen Sie den Wohnwagen sofort nach jeder Fahrt von Schlamm und Schmutz, um die saubere Oberfläche des Wohnwagens zu erhalten.
- Längerer Kontakt mit Schlamm, Schmutz und Salz kann die Oberfläche des Wohnmobils beschädigen.
- Die Karosserie des Wohnmobils kann mit Wasser und Seife unter Verwendung eines weichen Schwamms gewaschen werden; spülen Sie den Camper danach gründlich ab.
- Bei kleinen Flecken und Verschmutzungen kann ein feuchtes Tuch verwendet werden.
- Spezialprodukte wie Care-avan Waterless Wash & Shine können verwendet werden, wenn kein ausreichendes Wasser zur Verfügung steht. Es ist ratsam, jedes Produkt, das für den Camper verwendet werden soll, an einer kleinen, unauffälligen Stelle auszuprobieren, um sicherzustellen, dass es geeignet ist, bevor Sie es vollständig verwenden.
- Bei der Lagerung muss die Dachabdeckung stets verwendet werden (und zwar in Verbindung mit der mitgelieferten Abdeckhaube), um das Eindringen von Wasser zu verhindern und die Karosserie sauber zu halten.
- Jegliche Form von Beschädigungen oder Kratzern in der Lackierung des Wohnmobils auf der Karosserie kann mit einem geeigneten Ausbesserungsstift/einer geeigneten Farbe repariert oder gereinigt werden. Für weitere Informationen wenden Sie sich bitte direkt an OPUS® Camper.
- Wenn Ihr Wohnmobil mit einer Vinylfolie in einer individuellen Farbe beklebt wurde, muss darauf geachtet werden, dass sich die Folie nicht ablöst, wenn ein Kratzer oder Riss auf dem Karosserieblech entstanden ist.
- Die Pflege der Dachabdeckung ist wichtig; stellen Sie sicher, dass der Markisenwulst an der Vorderseite richtig eingesetzt ist, ohne dass das Material einreißt. Dazu kann ein geeignetes Gleitmittel verwendet werden. Ziehen Sie die vorderen Ecken über die Karosserie und wiederholen Sie den Vorgang auf der Rückseite; die Dachabdeckung sollte eng anliegen, ohne an den Ecken zu drücken. Sichern Sie die Abdeckung mit den Bungees an den Knopfklammern, die an den seitlichen und hinteren Karosserieteilen um den Camper herum angebracht sind.
- Die Knopfbefestigungen sind in erster Linie für das Zelt gedacht und werden NICHT alle zur Befestigung der Dachabdeckung benötigt.
...
- Vermeiden Sie die Verwendung von Scheuermitteln, einschließlich Scheuerschwämmen, um die Geräte zu reinigen, da diese Kratzer und Probleme mit der Oberfläche der Geräte verursachen können.

**VERGEWISSERN SIE SICH, DASS DER HERD/DAS KOCHFELD VOLLSTÄNDIG ABGEKÜHLT IST, BEVOR SIE VERSUCHEN, ES ZU REINIGEN.

- Vermeiden Sie es, heiße Gegenstände/Behälter (Tassen/Töpfe usw.) direkt auf die Geräte zu stellen; verwenden Sie eine geeignete Matte/Abdeckung, um die Oberflächen der Geräte nicht zu beschädigen.
- Wenn Sie den Camper zusammenpacken, verpacken Sie die Möbel mit einem angemessenen Schutz/einer angemessenen Polsterung (insbesondere die mittleren Regale und die Tischplatte) und vermeiden Sie eine Anordnung, die ein Verrutschen der Möbel und Regale während des Transports begünstigt, da dies zu Problemen mit der Oberfläche führen kann.
- Die Polster in Ihrem OPUS® Camper sind langlebig und bedürfen lediglich der richtigen Pflege und Verwendung.
- Reinigen Sie Flecken und Verschmutzungen auf den Polstern, sobald sie auftreten, am besten mit einem feuchten Tuch. Vermeiden Sie es, die Polster einzuweichen oder längere Zeit mit Wasser in Berührung zu bringen, und stellen Sie sicher, dass sie vor dem Packen des Wohnmobils gründlich getrocknet sind.
- Saugen Sie die Polster (und den Wohnwagen) regelmäßig oder so oft wie nötig ab, je nach Nutzungsgrad. Achten Sie besonders auf die Verkleidungen, da diese Schmutz oder unerwünschte Gegenstände enthalten können.
- Vermeiden Sie es, mit den Schuhen auf die Polster zu treten oder schmutzige Gegenstände darauf abzulegen.
...
Um die Möglichkeit einer Farbübertragung zu vermeiden, empfehlen wir Folgendes:

Drehen Sie die dunklen Kissen auf den Kopf, so dass die Filzrückseite zum Zelt hin offen liegt (es gibt keinen Konflikt zwischen dem farbechten Filzmaterial und dem Zeltmaterial). Dadurch wird der Kontakt zwischen den dunkelgrauen Kissenoberseiten und dem Zelt getrennt, aber Sie können die Kissenoberflächen vor den Scharnieren des Schrankes schützen, indem Sie ein geeignetes Material zwischen die beiden Gegenstände legen.

Alternativ können Sie ein helles, farbechtes Material (z. B. eine Sofadecke oder eine Decke) verwenden, um die Kissenoberseiten vor dem Einpacken abzudecken.
...
Wenn Sie das Ersatzrad und den Träger montiert haben (optionales Extra), vergewissern Sie sich, dass es einsatzbereit ist.

Er ist mit einer 19-mm-Sechskantschraube befestigt, die mit einem Standard-Radschlüssel gelöst werden kann.

**Sie müssen sicherstellen, dass die Schraube des Reserveradträgers mit einem Anzugsdrehmoment von 55 Nm vollständig angezogen ist. STELLEN SIE SICHER, DASS DER DRUCK DES ERSATZRADES REGELMÄSSIG ÜBERPRÜFT WIRD. DER RICHTIGE DRUCK IST 44 PSI oder 3 BAR.**
...
Kondenswasser entsteht, wenn warme, feuchte Luft mit kalten Oberflächen in Berührung kommt. Kondensation kann im Inneren der meisten Zelte und Vorzelte auftreten, was manchmal fälschlicherweise als Undichtigkeit des Gewebes gedeutet werden kann.

Wenn Sie ein wasserdichtes Zelt über feuchtem Boden aufstellen, ist immer Feuchtigkeit in der Luft; die Situation wird jedoch noch verschlimmert, wenn Personen hinzukommen, die warmen Wasserdampf ausatmen. Wenn die warme, feuchte Luft im Inneren mit dem Gewebe des OPUS Camper Zeltes oder dem Vorzeltmaterial in Berührung kommt, das durch die Außenluft abgekühlt wird, bildet sich Kondenswasser.

Bei Regen kann sich aufgrund der niedrigeren Außentemperatur mehr Kondenswasser bilden, und es können sich Tropfen bilden, die an den Nähten herunterlaufen oder auf die Innenstangen fallen, was den Anschein eines Lecks erweckt.

Es gibt einige Hauptursachen für Kondensation:

- Bodenfeuchtigkeit, die im Inneren Ihrer Markise aufsteigt. Ihr Atem - wenn Sie nachts schlafen, atmen Sie etwa 1 Liter Wasser aus. Dieser Wasserdampf ist in Ihrer OPUS®/Full Markise eingeschlossen - er entweicht durch geöffnete Fenster, Türen oder Lüftungsöffnungen.
- Lagern von feuchter oder nasser Kleidung.
- Kochen mit Gas - bei 0,5 Stunden Kochen können 0,5 l Wasser entstehen.

Es ist normal, dass der Körper während der Nacht schwitzt; bitte stellen Sie sicher, dass der Camper gut belüftet ist, um übermäßige Kondensation zu vermeiden, die zu Problemen wie Schimmel oder Feuchtigkeit führen kann, wenn nicht ausreichend darauf geachtet wird.

Nach der Nachtruhe bitte die Matratze inspizieren und umdrehen, um sicherzustellen, dass kein Kondenswasser vorhanden ist und die Matratze richtig gelüftet ist.

**Nachfolgend finden Sie Tipps und Produkte, die bei der Bekämpfung von Kondensation helfen können**.

Produkte:

- Vent-Air oder andere Matten, die Kondenswasserbildung verhindern
- Unibond Aero 360 Feuchtigkeitsabsorber
- Tragbare Luftentfeuchter

Tipps:

- Lagern Sie nasse Gegenstände draußen.
- Belüften Sie das Zelt - öffnen Sie die Fenster, wo immer möglich.
- Berühren Sie die Zeltseiten nicht - Druck auf die Zeltwände fördert das Durchsickern von Wasser.
- Stellen Sie das Zelt an einem Ort auf, an dem eine natürliche Brise weht.
...
- Überprüfen Sie das Kabel des Wohnmobils zum Zugfahrzeug und vergewissern Sie sich, dass es keinen Riss, keine Beschädigung des Steckers oder etwas Ungewöhnliches aufweist.
- Überprüfen Sie im Zugfahrzeug die Sicherung der Anhängerbeleuchtung, um sicherzustellen, dass sie nicht durchgebrannt ist.
- Prüfen Sie, ob die Glühbirne der Leuchte durchgebrannt ist; es ist ungewöhnlich/hoch unwahrscheinlich, dass mehr als eine Glühbirne durchbrennt, wenn es keine anderen Probleme mit der Verkabelung gibt. Daher sollte eine durchgebrannte Glühbirne ziemlich offensichtlich sein, da sie gut isoliert ist.

Wenn die Lichter zu schnell oder unregelmäßig blinken oder sich überhaupt nicht einschalten (dies kann der Fall sein, wenn Sie Ihr Zugfahrzeug wechseln):

- Schnelles Blinken kann auftreten, wenn das Zugfahrzeug den geringen Widerstand der LED-Leuchten im Wohnmobil erkennt und dies als durchgebrannte Glühbirne interpretiert; ein Widerstand kann ausreichen, um die erwartete Belastung für die Elektrik des Zugfahrzeugs zu erreichen.
- Jüngste Fortschritte in der Fahrzeugtechnologie erfordern bei einigen Fahrzeugen eine Umcodierung des CAN-Busses, wenn die Anhängerkupplung und die Abschlepp-Elektrik eingebaut werden; erkundigen Sie sich bei Ihrem Anhängerkupplungsmonteur, ob dies für Ihr Fahrzeug erforderlich ist.

Symptome:

OPUS-Lichter blinken/OPUS-Lichter flackern/OPUS-Lichter funktionieren überhaupt nicht

Fehlersuche:

Vergewissern Sie sich, dass der 13-polige Stecker an Ihrem Fahrzeug ordnungsgemäß funktioniert. Sie können dies entweder bei Ihrem Händler vor Ort testen oder, falls vorhanden, einen anderen Anhänger anschließen, um zu sehen, ob das Problem weiterhin besteht. Möglicherweise ist ein steckbares Smart Load Relay erforderlich.
...
Wenn sich die Heizung nicht einschaltet, prüfen Sie den Sicherheitsschalter unter dem Sitz - unter Kissen 1. Wenn der Schalter eingeschaltet ist und die Heizung trotzdem nicht funktioniert, ist möglicherweise die Sicherung durchgebrannt. Die Heizung muss nur kurz eingeschaltet werden, um das Innere des Wohnmobils bei Bedarf aufzuwärmen, und sollte danach wieder ausgeschaltet werden, da die isolierenden Eigenschaften des Wohnmobils diese Temperatur beibehalten.

Lassen Sie die Heizung niemals über Nacht, während des Schlafs, unbeaufsichtigt oder über einen längeren Zeitraum eingeschaltet.
...
Wenn ein Problem mit einer Steckdose oder einem elektrischen Gerät auftritt, das eine Verlängerung verwendet, ist es möglicherweise überlastet.
...
Die 12-Volt-Elektrik funktioniert möglicherweise nicht richtig oder überhaupt nicht, wenn die Batterie nicht ausreichend geladen ist. Der Ladezustand der Batterie kann mit dem Messgerät an der elektrischen Haupttafel neben der Tür des Wohnmobils überwacht werden. Weitere Informationen hierzu finden Sie auf Seite 21.
...
1.  Trennen Sie das Ende des Schlauchs ab, der den defekten Balken mit dem Rest des AIR-Systems verbindet.
2.  Lösen Sie den Reißverschluss der Schutzhülle, die den grauen Schlauch hält, und entfernen Sie den grauen Schlauch aus der Hülle.
3.  Lösen Sie die Bänder, die die Reißverschlüsse des grauen Rohrs zusammenhalten, und öffnen Sie den Reißverschluss.
4.  Entfernen Sie die Blase aus dem grauen Schlauch. Wenn Sie die Blase abnehmen, entfernen Sie die Blase, den Kunststoffschlauch und das Ventil.
5.  Nehmen Sie Ihre Ersatzblase (mit angeschlossenem Ventil und Schlauch) und setzen Sie sie so in den grauen Schlauch ein, dass das Ventil und der Kunststoffschlauch mit der entsprechenden Öffnung im grauen Schlauch übereinstimmen.
6.  Schieben Sie das Ventil durch das Loch in der Hülse.
7.  Die Blase ist länger als der graue Schlauch und es ist wichtig, dass Sie die Blase an beiden Enden vorsichtig und fest aufrollen und vorsichtig in den grauen Schlauch einführen. Das Aufrollen der Bladder an beiden Enden ist für die korrekte Funktion der Bladder unerlässlich. Wenn Sie dies nicht tun, kann die Blase an den Enden aufreißen und versagen.
8.  Schließen Sie anschließend vorsichtig die Reißverschlüsse am grauen Schlauch und achten Sie darauf, dass Sie die Blase nicht im Reißverschluss einklemmen und sichern Sie die Befestigungsbänder.
...
3.  Lösen Sie den Reißverschluss der Außenzelt-Halterung, die das graue Rohr hält, und nehmen Sie das graue Rohr aus der Halterung.
4.  Lösen Sie die Bänder, die die Reißverschlüsse des grauen Rohrs zusammenhalten, und öffnen Sie den Reißverschluss.
5.  Entfernen Sie die Blase aus dem grauen Schlauch. Wenn Sie die Blase abnehmen, entfernen Sie die Blase, den Kunststoffschlauch und das Ventil.
6.  Nehmen Sie Ihre Ersatzblase (mit angeschlossenem Ventil und Schlauch) und setzen Sie sie so in den grauen Schlauch ein, dass das Ventil und der Kunststoffschlauch mit der Öffnung im grauen Schlauch übereinstimmen.
7.  Schieben Sie das Ventil und den Schlauch durch die Öffnung in der Hülse.
8.  Die Blase ist länger als der graue Schlauch und es ist wichtig, dass Sie die Blase an beiden Enden vorsichtig und fest aufrollen und vorsichtig in den grauen Schlauch einführen. Das Aufrollen der Bladder ist für die korrekte Funktion der Bladder unerlässlich. Wenn Sie dies nicht tun, kann die Blase an den Enden aufreißen und versagen.
9.  Schließen Sie anschließend vorsichtig die Reißverschlüsse des grauen Schlauchs und achten Sie darauf, dass Sie die Blase nicht im Reißverschluss einklemmen und sichern Sie die Befestigungsbänder.
10.  Stecken Sie den grauen Schlauch wieder in die Außenzelt-Haltevorrichtung.
11.  Verbinden Sie den Schlauch mit dem Rest des AIR-Systems - schließen Sie den Schlauch an das schwarze Ventil an. Dies kann eine kurze Zeit des Schiebens und Manövrierens in Anspruch nehmen. Achten Sie darauf, dass der Schlauch vollständig in das schwarze Ventil eingesteckt ist, sonst funktioniert das AIR-System nicht.
12.  Schrauben Sie die Kappe fest auf, so dass sie auch den Verbindungsschlauch hält.
...
- Pumpe funktioniert nicht
    ...
    - Prüfen Sie die 20A-Sicherung (gelb) auf der Sicherungstafel im Gerät unter dem Kühlschrank und tauschen Sie sie bei Bedarf aus.
- Die Pumpe scheint abzuschalten, bevor das Zelt vollständig aufgeblasen ist
    - Prüfen Sie, ob der Druckregler der Pumpe auf die richtige Einstellung von 8PSI eingestellt ist.
    - Vergewissern Sie sich, dass die AIR-Stangen nicht gefaltet sind, was den Luftstrom einschränken würde.
- Das Aufblasen des Hauptzeltes dauert länger als gewöhnlich
    - Vergewissern Sie sich, dass alle externen AIR-Ablassventile in der geschlossenen Position sind.
    - Vergewissern Sie sich, dass Ihre AIR OPUS® Freizeitbatterie voll geladen ist.
- Das Aufblasen des Vorzeltes dauert länger als gewöhnlich.
    - Vergewissern Sie sich, dass alle Luftablassventile in der geschlossenen Position sind.
...
Sollte sich das Zelt an der Schiene verfangen oder verhaken, gehen Sie die Schritte zum Auf- und Abbau des Zeltes noch einmal durch, um die Markisenwülste zu führen und eine Beschädigung des Zeltes zu vermeiden.
...
Wenn Sie ein neues/unbekanntes Produkt verwenden, probieren Sie es an einer kleinen, unauffälligen Stelle aus und verwenden Sie es erst, wenn Sie mit der Eignung und dem Ergebnis des Produkts zufrieden sind.
...
Eine Nachimprägnierung kann auch erforderlich sein, wenn das Zelt mit bestimmten Reinigungsmitteln behandelt wurde.
...
Es ist möglich, dass kleinere Leckagen darauf zurückzuführen sind, dass das Segeltuch keinem Bewitterungsprozess unterzogen wurde. Wir verwenden für den OPUS® ausschließlich Baumwollsegeltuch, da dieses Material besonders haltbar und atmungsaktiv ist. Das bedeutet, dass das OPUS®, wie alle natürlichen Cotton Canvas Zelte, einen Verwitterungsprozess durchlaufen muss, bevor alle Baumwollfasern im Gewebe aufquellen und sich ineinander schmiegen. Dies kann dazu führen, dass bei den ersten Einsätzen unter nassen Bedingungen Wassertropfen durch das Zelt laufen. Die gute Nachricht ist, dass diese letzten Tropfen verschwinden und Sie ein perfekt wasserdichtes Zelt erhalten, das Ihnen bei guter Pflege viele Jahre lang gute Dienste leisten wird.
...
- Vergewissern Sie sich, dass die Gasflasche "offen" ist und dass der flexible Schlauch des Kochfeldes angeschlossen und eingeschaltet ist. Wenn das Gas-Kochfeld gerade erst angeschlossen oder eine neue Gasflasche montiert oder eingeschaltet wurde, dauert es eine Weile, bis das Gas zu den Brennern strömt. Halten Sie den Drehknopf des Gaskochfelds offen, während Sie die Piezozündungstaste drücken; das Gas zündet, sobald es aus dem Brenner austritt.
- Wenn das Kochfeld nach einigen Versuchen mit den obigen Schritten nicht zündet, drehen Sie den Kochfeldknopf, das Ventil und die Gasflasche ab und vergewissern Sie sich, dass es keine Lecks oder andere Probleme gibt.
- Wenn die obigen Schritte das Problem nicht beheben, sollten Sie die Gasmenge in der Gasflasche überprüfen und eventuell nachfüllen.

Lassen Sie das Gas NICHT fließen oder das Gas-Kochfeld eingeschaltet, wenn der Brenner nicht in Gebrauch ist.

Vergewissern Sie sich bei jedem Wechsel der Gasflasche, dass diese richtig angeschlossen ist.
...
Wenn kein Wasser aus dem Wasserhahn fließt, prüfen Sie die Schläuche und Anschlüsse, prüfen Sie die Pumpe und den Schalter und vergewissern Sie sich, dass der Frischwasserbehälter genügend Wasser enthält und die Pumpe vollständig eingetaucht ist.
...
Die Pumpe muss an die externe Steckdose angeschlossen werden, damit sie ordnungsgemäß funktioniert und Wasser an den Wasserhahn des Spülbeckens liefert.

Der Pumpenschalter befindet sich auf dem Bedienfeld an der Tür des Wohnmobils und muss eingeschaltet werden, damit die Pumpe funktioniert. Nach dem ersten Einschalten der Pumpe kann es sein, dass sie für eine kurze Zeit läuft. Dies ist normal und dient lediglich dazu, die Pumpe vorzubereiten, damit sie bei Bedarf sofort Wasser liefert.

Je nach Standort und Wasserdurchfluss muss der Druck möglicherweise angepasst werden, wenn der Wasserfluss nicht wie gewünscht ist. Dies kann über einen Drehschalter auf der Rückseite des Pumpenanschlusses eingestellt werden, der vom Inneren des Wohnmobils aus zugänglich ist (unter dem Küchenunterschrank).
...
Kontrollieren Sie regelmäßig und vor jeder Fahrt mit Ihrem OPUS® den Reifendruck. Der richtige Druck beträgt 44PSI oder 3BAR. Dies gilt für die mit Ihrem OPUS® gelieferten Reifen/Räder. Wenn Sie die Reifen/Räder verändert haben, halten Sie sich bitte an die Empfehlungen des Reifen-/Radherstellers.
